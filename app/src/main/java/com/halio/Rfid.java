...
public class Rfid {
	...
	//PSAM卡测试
	public static native boolean samClose();
	public static native boolean samReset(byte samNum,byte samBaud);
	public static native boolean samCos(byte samNum,byte[] cosCmd,int cosCmdLength,byte[] cosResponse,int[] cosResponseLength);

	//CPU卡测试
	public static native boolean iso14443bReset(byte bMode, byte[] pUID,byte[] pUIDLength);
	public static native boolean iso14443bCos(byte[] pCosCmd, int cosCmdLength,byte[] pCosResponse,int[] pBufLength);
	public static native boolean iso14443aReset(byte bMode,byte[] pCosResponse,byte[] pBufLength);
	public static native boolean iso14443aCos(byte[] pCosCmd, int cosCmdLength,byte[] pCosResponse,int[] pBufLength);

	//////////////////////////////////////////////////////////////
	public static native boolean iso14443aQueryUid(byte mode, byte[] UID);
	public static native boolean iso14443aReadCard(byte querymode,byte authmode,byte block,byte[] authkey,byte[] Data);
	public static native boolean iso14443aWriteCard(byte querymode,byte authmode,byte block,byte[] authkey,byte[] Data);

	public static native boolean iso14443aInitValue(byte querymode,byte authmode,byte block,byte[] authkey,byte[] value);
	public static native boolean iso14443aReadValue(byte querymode,byte authmode,byte block,byte[] authkey,byte[] value);

	public static native boolean iso14443aDecrement(byte querymode,byte authmode,byte block,byte[] authkey,byte[] value);
	public static native boolean iso14443aIncrement(byte querymode,byte authmode,byte block,byte[] authkey,byte[] value);
	public static native boolean iso14443aReadContinuous(byte querymode,byte authmode,byte block,byte[] authkey,byte blocknum,byte[] data);
	...
	public static native boolean iso15693Read(byte mode,byte[] UID,byte block,byte blocknum,byte[] data,byte[] datalen);
	public static native boolean iso15693write(byte mode,byte[] UID,byte block,byte[] data,byte datalen);
	...
	public static native boolean desfirecos(byte[] pCosCmd,	byte cosCmdLength, byte[] pCosResponse, int[] pBufLength);
	...
	public static native boolean DesFireCardChangeKey(byte bKeyNumber, byte[] pbNewKey,byte[] pbPrevKey,byte flag);
	...
	public static native boolean DesFireCardCreateApplication(long eNewApplicationID,int bKeySettings, byte bNApplicationKeys);
	public static native boolean DesFireCardDeleteApplication(long eApplicationID );

	public static native boolean DesFireCardGetApplicationIDs(byte bMaxApplicationIDs,byte[] peApplicationIDs,byte[] pbNApplicationIDs);
	public static native boolean DesFireCardCreateStdDataFile(byte bFileID,byte bCommMode,int wAccessRights,long eFileSize);
	public static native boolean DesFireCardCreateBackupDataFile(byte bFileID,byte bCommMode,int wAccessRights,long eFileSize);
	public static native boolean DesFireCardCreateValueFile(byte bFileID, byte bCommMode,int wAccessRights,long lLowerLimit, long lUpperLimit,long lInitialValue, byte bLimitedCreditEnabled);
	public static native boolean DesFireCardCreateCyclicRecordFile(byte bFileID,byte bCommMode,int wAccessRights,long eRecordSize,long eMaxNRecords);
	public static native boolean DesFireCardWriteData(byte bFileID, byte bCommMode,long eFromOffset,byte[] pbDataBuffer);
	public static native boolean DesFireCardChangeFileSettings(byte bFileID,byte bNewCommMode,int wNewAccessRights);
	public static native boolean DesFireCardReadData(byte bFileID,byte bCommMode,long eFromOffset,long eNBytesToRead,byte[] pbDataBuffer,long[] peNBytesRead );
	...
	public static native boolean DesFireCardWriteRecord(byte bFileID, byte bCommMode,long eFromOffset,byte[] pbDataBuffer );
	public static native boolean DesFireCardReadRecords(byte bFileID,byte bCommMode,long eFromRecord, long eNRecordsToRead,long eRecordSize,byte[] pbDataBuffer,long[] peNRecordsRead);
	public static native boolean DesFireCardCommitTransaction();
	public static native boolean DesFireCardGetFileIDs(byte bMaxFileIDs,byte[] pbFileIDBuffer,byte[] pbNFileIDsFound );
	public static native boolean DesFireCardDeleteFile(byte bFileID );

	public static native boolean DesFireCardGetFileSettings(byte bFileID,byte[] pbFileType, byte[] pbCommMode,int[] pwAccessRights,AdditionalFileSettings punAdditionalFileSettings);
	public static native boolean DesFireCardCreateLinearRecordFile(byte bFileID,byte bCommMode,int wAccessRights,long eRecordSize,long eMaxNRecords );
